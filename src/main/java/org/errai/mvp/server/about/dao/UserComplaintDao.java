package org.errai.mvp.server.about.dao;
...
public class UserComplaintDao {
     ...
     *
     * @param id The unique ID of the UserComplaint to delete. Must not be null.
     * @throws IllegalArgumentException if {@code id} is null, or if there is no UserComplaint with that
     *                                  ID in the database.
     */
